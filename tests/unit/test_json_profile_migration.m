...
profiles = [
    ...
    profile(repoRoot, ...
        ...
        true, "external_stream_mapping")
    profile(repoRoot, ...
        "config/01_mapping_profiles/external_streams/neural_ttl_event_mapping_profile", ...
        true, "external_stream_mapping")
    profile(repoRoot, ...
        "config/01_mapping_profiles/external_streams/acoustic_reference_event_mapping_profile", ...
        true, "external_stream_mapping")
    profile(repoRoot, ...
        "config/01_mapping_profiles/alignment_anchors/long_anchor_mapping_profile", ...
        true, "alignment_anchor_mapping")
    profile(repoRoot, ...
        "config/01_mapping_profiles/alignment_anchors/wide_anchor_mapping_profile", ...
        true, "alignment_anchor_mapping")
    profile(repoRoot, ...
        "config/01_mapping_profiles/tracking/generic_tracking_mapping_profile", ...
        true, "tracking_input_mapping")
    profile(repoRoot, ...
        "config/01_mapping_profiles/attribution/generic_imported_attribution_profile", ...
        true, "attribution_input_mapping")
    profile(repoRoot, ...
    ...
    profile(repoRoot, ...
        ...
        false, "")
    % Not executable, for the same reason as the matching specification: an
    % attribution decision policy declares thresholds and status rules rather
    % than how to interpret a table. It is read directly and registered as a
    % checksum-bearing config profile version.
    profile(repoRoot, ...
        "config/08_attribution_policies/prototype_attribution_decision_policy", ...
        false, "")
    ];
end
