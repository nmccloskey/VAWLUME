...
rows = fetch(conn, "SELECT dm.derived_measurement_id, dm.metric_definition_id, " + ...
    ...
    "IFNULL(ar.frequency_min_hz,-1.0) AS frequency_min_hz, " + ...
    "IFNULL(ar.frequency_max_hz,-1.0) AS frequency_max_hz, ar.recording_id, " + ...
...
rows = fetch(conn, "SELECT channel_response_estimate_id, estimate_key, " + ...
    ...
    "aggregation_method, aggregation_version, IFNULL(frequency_min_hz,-1.0) AS frequency_min_hz, " + ...
    "IFNULL(frequency_max_hz,-1.0) AS frequency_max_hz, qc_status, " + ...
