...
result.tracking_streams = stableSort(result.tracking_streams, "stream_key");
result.tracking_series = stableSort(result.tracking_series, "series_key");
result.tracking_columns = stableSort(result.tracking_columns, "column_key");
...
result.summary = struct( ...
    ...
    tracking_stream_count=height(result.tracking_streams), ...
    tracking_series_count=height(result.tracking_series), ...
    tracking_column_count=height(result.tracking_columns), ...
