...
value = "SELECT s.agreement_group_id, s.analysis_run_id, " + ...
    "s.agreement_run_key, s.recording_id, s.native_recording_id, " + ...
    "s.group_key, s.derivation_method, s.member_count, " + ...
    "s.extraction_run_count, s.extractor_count, s.extractor_set_key, " + ...
    "s.extractor_set_label, s.extraction_run_set_key, " + ...
    ...
    "s.supported_extractor_pair_pattern, " + ...
    "s.supported_extractor_pair_label, " + ...
    "s.unsupported_extractor_pair_pattern, " + ...
    "s.unsupported_extractor_pair_label, " + ...
    ...
    "s.pairwise_topology_pattern, " + ...
    "s.ambiguous_pairwise_topology_pattern, s.is_singleton, " + ...
...
value = "SELECT m.agreement_group_id, m.analysis_run_id, " + ...
    "m.agreement_run_key, m.recording_id, m.native_recording_id, " + ...
    "m.group_key, m.derivation_method, m.detection_id, m.member_role, " + ...
    "m.extraction_run_id, m.extraction_run_key, m.extractor_id, " + ...
    "m.extractor_key, m.extractor_name, m.extractor_version_id, " + ...
    "m.extractor_version, m.native_event_id, m.event_subtype, " + ...
    "m.start_time_s, m.end_time_s, m.duration_s " + ...
    "FROM v_agreement_group_members m";
end

function rows = normalizeGroups(rows)
rows = normalizeText(rows, ["agreement_run_key", "native_recording_id", ...
