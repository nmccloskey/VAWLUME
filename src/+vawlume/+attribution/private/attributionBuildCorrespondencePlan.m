...
rows = fetch(conn, "SELECT imported_attribution_window_id AS window_id, " + ...
    ...
    "IFNULL(source_caller_label,'') AS source_caller_label, " + ...
...
windows.source_caller_label = presentText(rows.source_caller_label);
